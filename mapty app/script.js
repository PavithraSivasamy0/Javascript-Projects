...
class App {
  ...
  _loadMap(position) {
    ...
    const coordArr = [latitude, longitude];
    this.#map = L.map('map').setView(coordArr, this.#mapZoomLevel);
  ...
  _newWorkout(e) {
    ...
    // check workout running, create running object
    if (type === 'running') {
    ...
    // check workout cycling, create cycling object
    if (type === 'cycling') {
    ...
    // set local storga to all workouts
